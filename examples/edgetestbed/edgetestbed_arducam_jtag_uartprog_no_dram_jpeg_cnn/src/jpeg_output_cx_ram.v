...
if (rst_i)
    ...
    cx_idx_q    <= ((cx_idx_q == 8'd127) && mode422_i) ? 0 : cx_idx_q + 8'd1;
...
wire [7:0] rd_addr_w = (mode420_i || mode422_i) ? {cx_half_q, cx_rd_ptr_q} : rd_ptr_q;
...
begin
    ...
    if (push_i)
        count_r = count_r + (mode420_i ? 32'd4 : (mode422_i ? 32'd2 : 32'd1));
end
