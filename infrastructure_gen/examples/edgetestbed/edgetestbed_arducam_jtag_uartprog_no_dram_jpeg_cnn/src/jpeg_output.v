...
//-----------------------------------------------------------------
// This file has been modified to add support for YCBCR 4:2:2 
...
localparam JPEG_MONOCHROME  = 3'd0;
localparam JPEG_YCBCR_444   = 3'd1;
localparam JPEG_YCBCR_420   = 3'd2;
localparam JPEG_YCBCR_422   = 3'd3;
localparam JPEG_UNSUPPORTED = 3'd4;
...
(
    ...
    ,.mode422_i(img_mode_i == JPEG_YCBCR_422)
...
if (rst_i)
    ...
    subsmpl_q <= 2'b0;
else if (valid_r && output_space_w && (img_mode_i == JPEG_YCBCR_420  || img_mode_i == JPEG_YCBCR_422) && idx_q == 6'd63)
    subsmpl_q <= ((img_mode_i == JPEG_YCBCR_422) && subsmpl_q[0]) ? 0 : subsmpl_q + 2'd1;
...
begin
    if (img_mode_i == JPEG_MONOCHROME)
        ...
        active_q <= 1'b1;
    else if (img_mode_i == JPEG_YCBCR_420)// 420
        active_q <= (y_level_w >= 32'd256) && (cb_level_w >= 32'd256) && (cr_level_w >= 32'd256);
    else
        active_q <= (y_level_w >= 32'd128) && (cb_level_w >= 32'd128) && (cr_level_w >= 32'd128);
end
...
begin
    ...
    if (img_mode_i == JPEG_MONOCHROME || GRAYSCALE == 1)
    begin
